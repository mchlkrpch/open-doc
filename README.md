...
**Open-Doc** — QA датасет, предназначенный для обучения и оценки RAG-пайплайнов. Содержит **~1K вопросов** по документам из четырёх тематических категорий: научные статьи, технические документации, финансовые отчеты, юридические документы. Все документы и статьи приведены на русском языке.
